...
export const LAYERS: Layer[] = [
  ...
  },
  {
    ...
    from: 15,
    tint: 0xb8b0a8,
    weights: { dirt: 600, stone: 250, bedrock: 15, tnt: 12, dynamite: 12, bonus: 10, chest: 4, hourglass: 3, lamp: 3, magnet: 3, chicken: 3, coal: 35, iron: 35, gold: 18, diamond: 13 },
  },
  {
    name: 'Caverne',
    from: 40,
    tint: 0x8a90b8,
    weights: { dirt: 450, stone: 300, bedrock: 40, tnt: 25, dynamite: 15, bonus: 12, chest: 6, hourglass: 3, lamp: 3, magnet: 3, chicken: 4, coal: 40, iron: 45, gold: 45, diamond: 28 },
  },
  {
    name: 'Magma',
    from: 80,
    tint: 0xe07050,
    weights: { dirt: 300, stone: 350, bedrock: 80, tnt: 30, dynamite: 20, bonus: 12, chest: 8, hourglass: 3, lamp: 3, magnet: 4, chicken: 4, coal: 30, iron: 50, gold: 60, diamond: 68 },
  },
];
